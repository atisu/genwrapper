 ...
 */
#define AUTOCONF_TIMESTAMP "2008-03-27 20:32:05 CET"
...
#undef CONFIG_FEATURE_VOLUMEID_UFS
#define ENABLE_FEATURE_VOLUMEID_UFS 0
#define USE_FEATURE_VOLUMEID_UFS(...)
#define SKIP_FEATURE_VOLUMEID_UFS(...) __VA_ARGS__
...
#undef CONFIG_FEATURE_VOLUMEID_LVM
#define ENABLE_FEATURE_VOLUMEID_LVM 0
#define USE_FEATURE_VOLUMEID_LVM(...)
#define SKIP_FEATURE_VOLUMEID_LVM(...) __VA_ARGS__
...
#undef CONFIG_FEATURE_VOLUMEID_HPFS
#define ENABLE_FEATURE_VOLUMEID_HPFS 0
#define USE_FEATURE_VOLUMEID_HPFS(...)
#define SKIP_FEATURE_VOLUMEID_HPFS(...) __VA_ARGS__
...
#define USE_FEATURE_VOLUMEID_MINIX(...)
#define SKIP_FEATURE_VOLUMEID_MINIX(...) __VA_ARGS__
#undef CONFIG_FEATURE_VOLUMEID_MAC
#define ENABLE_FEATURE_VOLUMEID_MAC 0
#define USE_FEATURE_VOLUMEID_MAC(...)
#define SKIP_FEATURE_VOLUMEID_MAC(...) __VA_ARGS__
#undef CONFIG_FEATURE_VOLUMEID_MSDOS
#define ENABLE_FEATURE_VOLUMEID_MSDOS 0
#define USE_FEATURE_VOLUMEID_MSDOS(...)
#define SKIP_FEATURE_VOLUMEID_MSDOS(...) __VA_ARGS__
...
#undef CONFIG_FEATURE_VOLUMEID_HIGHPOINTRAID
#define ENABLE_FEATURE_VOLUMEID_HIGHPOINTRAID 0
#define USE_FEATURE_VOLUMEID_HIGHPOINTRAID(...)
#define SKIP_FEATURE_VOLUMEID_HIGHPOINTRAID(...) __VA_ARGS__
#undef CONFIG_FEATURE_VOLUMEID_ISWRAID
#define ENABLE_FEATURE_VOLUMEID_ISWRAID 0
#define USE_FEATURE_VOLUMEID_ISWRAID(...)
#define SKIP_FEATURE_VOLUMEID_ISWRAID(...) __VA_ARGS__
#undef CONFIG_FEATURE_VOLUMEID_LSIRAID
#define ENABLE_FEATURE_VOLUMEID_LSIRAID 0
#define USE_FEATURE_VOLUMEID_LSIRAID(...)
#define SKIP_FEATURE_VOLUMEID_LSIRAID(...) __VA_ARGS__
#undef CONFIG_FEATURE_VOLUMEID_VIARAID
#define ENABLE_FEATURE_VOLUMEID_VIARAID 0
#define USE_FEATURE_VOLUMEID_VIARAID(...)
#define SKIP_FEATURE_VOLUMEID_VIARAID(...) __VA_ARGS__
#undef CONFIG_FEATURE_VOLUMEID_SILICONRAID
#define ENABLE_FEATURE_VOLUMEID_SILICONRAID 0
#define USE_FEATURE_VOLUMEID_SILICONRAID(...)
#define SKIP_FEATURE_VOLUMEID_SILICONRAID(...) __VA_ARGS__
#undef CONFIG_FEATURE_VOLUMEID_NVIDIARAID
#define ENABLE_FEATURE_VOLUMEID_NVIDIARAID 0
#define USE_FEATURE_VOLUMEID_NVIDIARAID(...)
#define SKIP_FEATURE_VOLUMEID_NVIDIARAID(...) __VA_ARGS__
#undef CONFIG_FEATURE_VOLUMEID_PROMISERAID
#define ENABLE_FEATURE_VOLUMEID_PROMISERAID 0
#define USE_FEATURE_VOLUMEID_PROMISERAID(...)
#define SKIP_FEATURE_VOLUMEID_PROMISERAID(...) __VA_ARGS__
...
#undef CONFIG_FEATURE_SENDMAIL_EHLO
#define ENABLE_FEATURE_SENDMAIL_EHLO 0
#define USE_FEATURE_SENDMAIL_EHLO(...)
#define SKIP_FEATURE_SENDMAIL_EHLO(...) __VA_ARGS__
#undef CONFIG_FEATURE_SENDMAIL_BLOATY
#define ENABLE_FEATURE_SENDMAIL_BLOATY 0
#define USE_FEATURE_SENDMAIL_BLOATY(...)
#define SKIP_FEATURE_SENDMAIL_BLOATY(...) __VA_ARGS__
#undef CONFIG_FETCHMAIL
#define ENABLE_FETCHMAIL 0
#define USE_FETCHMAIL(...)
#define SKIP_FETCHMAIL(...) __VA_ARGS__
#undef CONFIG_FEATURE_FETCHMAIL_APOP
#define ENABLE_FEATURE_FETCHMAIL_APOP 0
#define USE_FEATURE_FETCHMAIL_APOP(...)
#define SKIP_FEATURE_FETCHMAIL_APOP(...) __VA_ARGS__
#undef CONFIG_FEATURE_FETCHMAIL_FILTER
#define ENABLE_FEATURE_FETCHMAIL_FILTER 0
#define USE_FEATURE_FETCHMAIL_FILTER(...)
#define SKIP_FEATURE_FETCHMAIL_FILTER(...) __VA_ARGS__
